    ...
    <div className="rounded-lg border border-border bg-card p-6">
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Descarga el archivo ZIP de la extension desde este proyecto
              </p>
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-medium">Introducir ID de la extension</h3>
              <p className="text-muted-foreground text-sm mt-1">
                Copia el ID de la extension instalada y pegalo aqui
              </p>
      ...
      {isConnected && (
        <div className="mt-4 flex gap-2">
          <Button variant="outline" size="sm" onClick={onOpenFindMyDevice}>
            <ExternalLink className="w-4 h-4 mr-2" />
            Abrir Find My Device
          </Button>
        </div>
